...
class LRUCache(object):
    ...
    Runtime: 216 ms, faster than 57.45% of Python3 online submissions for LRU Cache.
    Memory Usage: 23.7 MB, less than 6.06% of Python3 online submissions for LRU Cache.
