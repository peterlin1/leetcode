...
class Solution(object):
    ...
    def possibleBipartition(self, N, dislikes):
        ...
        Runtime: 868 ms, faster than 28.85% of Python3 online submissions for Possible Bipartition.
        Memory Usage: 22.2 MB, less than 100.00% of Python3 online submissions for Possible Bipartition.
