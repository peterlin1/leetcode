class Solution(object):
    ...
    def islandPerimeter(self, grid):
        ...
        Runtime: 528 ms, faster than 75.08% of Python3 online submissions for Island Perimeter.
        Memory Usage: 12.7 MB, less than 100.00% of Python3 online submissions for Island Perimeter.
