class Solution(object):
    ...
    def maxUncrossedLines(self, A, B):
        ...
        Same solution as 1143_Longest_Common_Subsequence
        Runtime: 200 ms, faster than 92.49% of Python3 online submissions for Uncrossed Lines.
        Memory Usage: 13.9 MB, less than 46.81% of Python3 online submissions for Uncrossed Lines.
