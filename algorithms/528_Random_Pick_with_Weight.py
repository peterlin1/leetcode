...
class Solution(object):
    ...
    def pickIndex(self):
        ...
        Runtime: 332 ms, faster than 33.60% of Python3 online submissions for Random Pick with Weight.
        Memory Usage: 18.2 MB, less than 77.39% of Python3 online submissions for Random Pick with Weight.
